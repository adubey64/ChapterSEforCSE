...
\comment{KA NOTE:  I have a couple issue with this section.  First, all codes have some level of abstraction to the user that is treated like a black box, so I think claiming there is a fundamental requirement to understand the code needs to be explained further.  For example, I would assume a large number of code users, think of math libraries somewhat like a black box, be it petsc or fftw.  In addition, users of bioinformatics software, like BLAST or other alignment software, may not really know the algorithm at all, so I think we need to soften the claim about 'good results', unless we can back it up more.  The second 1/2 is very vague....}