...
behind that in the commercial software space. \comment{KA NOTE: Do we have any
reference for this claim? AD: I don't know of one, though this seems
to be the consensus} There are many reasons for it, first, is
...
\comment{KA NOTE: This last sentence is vague...  can we clarify? Is this about about lack of funding for development and maintenance?}
\response{AD: does the modification address your point ? }
